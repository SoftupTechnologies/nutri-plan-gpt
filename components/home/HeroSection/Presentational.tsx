...
const HeroSection: React.FC = () => (
  <div className=" py-16 max-w-xxl px-0 md:px-5 xl:px-0 ">
    <h1 className="mx-auto max-w-4xl text-center font-display text-3xl font-bold tracking-normal text-section-title sm:text-5xl  md:text-7xl">
      ...
      <span className="relative whitespace-nowrap text-primary">
        <svg
          aria-hidden="true"
          viewBox="0 0 418 42"
          className="opacity-12 absolute top-2/3 left-0 h-[0.58em] w-full fill-primary opacity-30 "
    ...
    <h2 className="text-md leading-2 mx-auto mt-12 max-w-xl text-center text-section-subtitle sm:text-lg sm:leading-7">
